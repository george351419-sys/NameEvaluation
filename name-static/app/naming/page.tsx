    ...
    <div className="min-h-screen bg-gradient-to-b from-[#fdfaf5] to-[#efe8d8]">
        ...
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="flex rounded-lg border overflow-hidden text-sm">
              ...
              <Link href="/naming" className="px-3 py-1.5 bg-gradient-to-r from-[#8b653a] to-[#c4954a] text-white font-medium border-l">
                命名建议
              </Link>
            </div>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-3xl font-bold text-[#3d2b10]">人名命名建议</h2>
